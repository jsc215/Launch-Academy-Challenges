...
puts "#{crypt_of_civilization.first} is the first item in the array."
puts "#{crypt_of_civilization.last} is the last item in the array."
puts "#{crypt_of_civilization[1]} is the second item in the array."
puts "#{crypt_of_civilization[2]} is the third item in the array."
puts "#{crypt_of_civilization[-2]} is the second from last item in the array."
puts "The index of Toast-O-Lator is #{crypt_of_civilization.index("Toast-O-Lator")}"
...
crypt_of_civilization.sort_by { |word| word.length }
...
crypt_of_civilization.each do |element|
  puts element
end
